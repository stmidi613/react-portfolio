      ...
      <div className="bg-teal h-full">
        <form action="" className="flex flex-col justify-center items-center">
          <div>
            <label
              htmlFor="name"
              className="mt-20 block text-sm font-medium text-yellow"
            >
              Name
            </label>
            <input
            ...
            <label
              htmlFor="email"
              className="mt-10 block text-sm font-medium text-yellow"
            >
              Email
            </label>
            <input
            ...
            <label
              htmlFor="comment"
              className="border-b-2block text-sm font-medium text-yellow"
            >
              Comment
            </label>
            <textarea
            ...
            <button
              type="submit"
              className="text-yellow bg-white border-yellow border-2 rounded-md px-2 py-1 mb-20 hover:drop-shadow-lg"
            >
              Submit
            </button>
          </div>
